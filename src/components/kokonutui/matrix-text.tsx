...
const MatrixText = ({
    ...
    useEffect(() => {
        const timer = setTimeout(startAnimation, initialDelay); // Initial delay
        const interval = setInterval(startAnimation, 2500); // Repeat every 1.4 seconds
        return () => {
            clearTimeout(timer); // Clear the initial delay timer
