      ...
      <div className="container mx-auto px-4 py-12 md:px-8 h-full">
        <div className="flex w-full flex-col items-center justify-center h-full">
          <div className="relative flex w-full flex-col items-center justify-center overflow-hidden h-full">
            ...
            <Marquee reverse className="[--duration:25s] h-full" repeat={5}>
            ...
            <Marquee
              reverse
              className="-delay-[200ms] [--duration:20s] h-full"
              repeat={5}
            >
              {randomTiles1.map((review, idx) => (
                <Card key={idx} {...review} />
            ...
            <Marquee reverse className="[--duration:30s] h-full" repeat={5}>
              {randomTiles2.map((review, idx) => (
                <Card key={idx} {...review} />
              ))}
            </Marquee>
